# ExternalContactsExternalContactIdBody
...
**id** | **str** | The customer-configured external contact ID. We recommend that you use a primary key from the original phone system.  If you do **not** use this parameter, the API automatically generates an &#x60;externalContactId&#x60;. | [optional] 
