...
class PhonePlansApi(object):
    ...
    def list_phone_plans(self, **kwargs):  # noqa: E501
        """List plan information  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_phone_plans(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_phone_plans_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_phone_plans_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_phone_plans_with_http_info(self, **kwargs):  # noqa: E501
        """List plan information  # noqa: E501

        Use this API to return all of an account's Zoom Phone [plan package](https://marketplace.zoom.us/docs/api-reference/other-references/plans#additional-zoom-phone-plans-and-codes), phone number usage and availability.  **Prerequisites:**  * A Pro or a higher account  * A Zoom Phone license  **Scopes:** `phone:read:admin`  **[Rate Limit Label](https://developers.zoom.us/docs/api/rest/rate-limits/):** `Medium`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_phone_plans_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_phone_plans" % key
                )
            params[key] = val
        del params['kwargs']
