...
class InlineResponse20030SettingsRouting(object):
    ...
    def __init__(self, action=None, forward_to=None, operator=None, connect_to_operator=None, allow_callers_check_voicemail=None, voicemail_greeting=None, require_press_1_before_connecting=None, overflow_play_callee_voicemail_greeting=None, play_callee_voicemail_greeting=None, busy_play_callee_voicemail_greeting=None):  # noqa: E501
        """InlineResponse20030SettingsRouting - a model defined in Swagger"""  # noqa: E501
        self._action = None
    ...
    @property
    def action(self):
        """Gets the action of this InlineResponse20030SettingsRouting.  # noqa: E501
        ...
        :return: The action of this InlineResponse20030SettingsRouting.  # noqa: E501
        :rtype: int
        """
        return self._action
    ...
    def action(self, action):
        """Sets the action of this InlineResponse20030SettingsRouting.

        The extension's forwarding or overflow information. For `call_not_answered`:  * `1` — Forward to a voicemail/videomail.  * `2` - Forward to the user.  * `4` - Forward to the common area.  * `6` - Forward to the auto receptionist.  * `7` - Forward to a call queue.  * `8` - Forward to a shared line group.  * `9` - Forward to an external contact.  * `10` - Forward to an external number.  * `11` — Disconnect.  * `12` — Play a message, then disconnect.  For `busy_on_another_call_action`:  * `21` - Call waiting.  * `22` - Play a busy signal.  * `1` — Forward to a voicemail/videomail.  * `2` - Forward to the user.  * `4` - Forward to the common area.  * `6` - Forward to the auto receptionist.  * `7` - Forward to a call queue.  * `8` - Forward to a shared line group.  * `9` - Forward to an external contact.  * `10` - Forward to an external number.  * `12` — Play a message, then disconnect.  # noqa: E501

        :param action: The action of this InlineResponse20030SettingsRouting.  # noqa: E501
        :type: int
        """
    ...
    @property
    def forward_to(self):
        """Gets the forward_to of this InlineResponse20030SettingsRouting.  # noqa: E501


        :return: The forward_to of this InlineResponse20030SettingsRouting.  # noqa: E501
    ...
    def forward_to(self, forward_to):
        """Sets the forward_to of this InlineResponse20030SettingsRouting.


        :param forward_to: The forward_to of this InlineResponse20030SettingsRouting.  # noqa: E501
    ...
    @property
    def operator(self):
        """Gets the operator of this InlineResponse20030SettingsRouting.  # noqa: E501


        :return: The operator of this InlineResponse20030SettingsRouting.  # noqa: E501
    ...
    def operator(self, operator):
        """Sets the operator of this InlineResponse20030SettingsRouting.


        :param operator: The operator of this InlineResponse20030SettingsRouting.  # noqa: E501
    ...
    def connect_to_operator(self):
        """Gets the connect_to_operator of this InlineResponse20030SettingsRouting.  # noqa: E501
        ...
        :return: The connect_to_operator of this InlineResponse20030SettingsRouting.  # noqa: E501
        :rtype: bool
        """
    ...
    def connect_to_operator(self, connect_to_operator):
        """Sets the connect_to_operator of this InlineResponse20030SettingsRouting.

        Whether to allow callers to reach an operator. Returned only for the `user` and `call_handling` subsetting. Displayed when the `call_not_answer_action` setting or `busy_on_another_call_action` setting is set to `1` (Forward to a voicemail).  # noqa: E501

        :param connect_to_operator: The connect_to_operator of this InlineResponse20030SettingsRouting.  # noqa: E501
        :type: bool
        """
    ...
    def allow_callers_check_voicemail(self):
        """Gets the allow_callers_check_voicemail of this InlineResponse20030SettingsRouting.  # noqa: E501
        ...
        :return: The allow_callers_check_voicemail of this InlineResponse20030SettingsRouting.  # noqa: E501
        :rtype: bool
        """
    ...
    def allow_callers_check_voicemail(self, allow_callers_check_voicemail):
        """Sets the allow_callers_check_voicemail of this InlineResponse20030SettingsRouting.

        Whether to allow the callers to check voicemails over a phone. Returned only for the `user` and `call_handling` subsetting. Displayed when the `call_not_answer_action` setting or `busy_on_another_call_action` setting is set to `1` (Forward to a voicemail).  # noqa: E501

        :param allow_callers_check_voicemail: The allow_callers_check_voicemail of this InlineResponse20030SettingsRouting.  # noqa: E501
        :type: bool
        """
    ...
    def voicemail_greeting(self):
        """Gets the voicemail_greeting of this InlineResponse20030SettingsRouting.  # noqa: E501


        :return: The voicemail_greeting of this InlineResponse20030SettingsRouting.  # noqa: E501
    ...
    def voicemail_greeting(self, voicemail_greeting):
        """Sets the voicemail_greeting of this InlineResponse20030SettingsRouting.


        :param voicemail_greeting: The voicemail_greeting of this InlineResponse20030SettingsRouting.  # noqa: E501
    ...
    def require_press_1_before_connecting(self):
        """Gets the require_press_1_before_connecting of this InlineResponse20030SettingsRouting.  # noqa: E501
        ...
        :return: The require_press_1_before_connecting of this InlineResponse20030SettingsRouting.  # noqa: E501
        :rtype: bool
        """
    ...
    def require_press_1_before_connecting(self, require_press_1_before_connecting):
        """Sets the require_press_1_before_connecting of this InlineResponse20030SettingsRouting.

        When a call is forwarded to a personal phone number, whether the user must press \"1\" before the call connects. This helps to ensure that missed calls do not reach to your personal voicemail. Returned for the `Forward to an external number` and `Forward to External Contacts` options.  # noqa: E501

        :param require_press_1_before_connecting: The require_press_1_before_connecting of this InlineResponse20030SettingsRouting.  # noqa: E501
        :type: bool
        """
    ...
    def overflow_play_callee_voicemail_greeting(self):
        """Gets the overflow_play_callee_voicemail_greeting of this InlineResponse20030SettingsRouting.  # noqa: E501
        ...
        :return: The overflow_play_callee_voicemail_greeting of this InlineResponse20030SettingsRouting.  # noqa: E501
        :rtype: bool
        """
    ...
    def overflow_play_callee_voicemail_greeting(self, overflow_play_callee_voicemail_greeting):
        """Sets the overflow_play_callee_voicemail_greeting of this InlineResponse20030SettingsRouting.

        Whether to play callee's voicemail greeting when caller reaches end of forwarding sequence. Displayed when `call_not_answer_action` set to `2` - Forward to the user, `4` - Forward to the common area, `6` - Forward to the auto receptionist, `7` - Forward to a call queue, `8` - Forward to a shared line group, `9` - Forward to an external contact, `10` - Forward to an external number.  # noqa: E501

        :param overflow_play_callee_voicemail_greeting: The overflow_play_callee_voicemail_greeting of this InlineResponse20030SettingsRouting.  # noqa: E501
        :type: bool
        """
    ...
    def play_callee_voicemail_greeting(self):
        """Gets the play_callee_voicemail_greeting of this InlineResponse20030SettingsRouting.  # noqa: E501
        ...
        :return: The play_callee_voicemail_greeting of this InlineResponse20030SettingsRouting.  # noqa: E501
        :rtype: bool
        """
    ...
    def play_callee_voicemail_greeting(self, play_callee_voicemail_greeting):
        """Sets the play_callee_voicemail_greeting of this InlineResponse20030SettingsRouting.

        Whether to play callee's voicemail greeting when caller reaches end of forwarding sequence. Displayed when `busy_routing` action or `call_not_answer_action` set to `1` - Forward to a voicemail.  # noqa: E501

        :param play_callee_voicemail_greeting: The play_callee_voicemail_greeting of this InlineResponse20030SettingsRouting.  # noqa: E501
        :type: bool
        """
    ...
    def busy_play_callee_voicemail_greeting(self):
        """Gets the busy_play_callee_voicemail_greeting of this InlineResponse20030SettingsRouting.  # noqa: E501

        Whether to play callee's voicemail greeting when caller reaches end of forwarding sequence. Displayed when `busy_routing` action set to `2` - Forward to the user, `4` - Forward to the common area, `6` - Forward to the auto receptionist, `7` - Forward to a call queue, `8` - Forward to a shared line group, `9` - Forward to an external contact, `10` - Forward to an external number.  # noqa: E501

        :return: The busy_play_callee_voicemail_greeting of this InlineResponse20030SettingsRouting.  # noqa: E501
        :rtype: bool
        """
    ...
    def busy_play_callee_voicemail_greeting(self, busy_play_callee_voicemail_greeting):
        """Sets the busy_play_callee_voicemail_greeting of this InlineResponse20030SettingsRouting.

        Whether to play callee's voicemail greeting when caller reaches end of forwarding sequence. Displayed when `busy_routing` action set to `2` - Forward to the user, `4` - Forward to the common area, `6` - Forward to the auto receptionist, `7` - Forward to a call queue, `8` - Forward to a shared line group, `9` - Forward to an external contact, `10` - Forward to an external number.  # noqa: E501

        :param busy_play_callee_voicemail_greeting: The busy_play_callee_voicemail_greeting of this InlineResponse20030SettingsRouting.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InlineResponse20030SettingsRouting, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InlineResponse20030SettingsRouting):
            return False
