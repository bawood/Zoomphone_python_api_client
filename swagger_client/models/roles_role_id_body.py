...
class RolesRoleIdBody(object):
    ...
    def name(self):
        ...
        User's [role](https://support.zoom.us/hc/en-us/articles/115001078646-Role-Based-Access-Control) name. Name length can be up to 128 characters  # noqa: E501
    ...
    def description(self):
        ...
        Role description. Description length can be up to 255 characters  # noqa: E501
